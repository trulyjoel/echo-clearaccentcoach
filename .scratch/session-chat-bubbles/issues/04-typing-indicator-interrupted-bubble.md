...
**What to build:** Callie's side of the conversation thread gets its own turn-status lifecycle: a
...
- [ ] An animated typing-indicator bubble appears in Callie's position immediately when the user's
